...
class payment_interswitchauto(osv.Model):
    ...
    def _get_providers(self, cr, uid, context=None):
        providers = super(payment_interswitchauto, self)._get_providers(cr, uid, context=context)
        providers.append(['interswitchauto', 'Interswitch Auto'])
        return providers

    # def interswitchauto_compute_fees(self, cr, uid, id, amount, currency_id, country_id, context=None):
    ...
    def interswitchauto_form_generate_values(self, cr, uid, id, partner_values, tx_values, context=None):
        ...
        _logger.info("itx_tx_values %r" % itx_tx_values)
        tx_values.update(itx_tx_values)
        return partner_values, tx_values

    def interswitchauto_get_form_action_url(self, cr, uid, id, context=None):
